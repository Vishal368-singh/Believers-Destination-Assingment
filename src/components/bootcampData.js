// Centralized page data keeps repeatable UI sections easy to update and debug.
...
export const differenceCards = [
  {
    ...
    description: 'Daily testing, analysis and revision keeps the preparation moving.',
  },
  {
    number: '02',
    tag: 'Specific Focus',
    title: 'Exam-Specific Focus',
    description: 'Designed for NEET PG, INI-CET and FMGE, not a generic crash course.',
  },
  {
    number: '03',
    tag: 'Day-by-Day Schedule',
    title: 'Accountability & Discipline',
    description: 'A structured routine keeps procrastination away and ensures completion.',
  },
  {
    number: '04',
    tag: 'Mentorship Driven',
    title: 'Mental Conditioning',
    description: 'Strategy, consistency and mindset are treated as part of the program.',
  },
  {
    number: '05',
    tag: 'End-to-End Prep',
